...
h=3; %W/(m^2*K); Coefficient de transfert thermique pour l'interface plane entre l'air et solide.

% Condition convective (de Robin) à x=0 (face externe du mur): -k*dT/dx=h(Ta-T)
Ta=-10; %oC
c1=-k; c2=h; c3=-h*Ta;
% Condition de (de Robin) à x=L (face interne du mur): -k*dT/dx=h(T-Ti)
Ti=20;
d1=-k; d2=-h; d3=h*Ti;
